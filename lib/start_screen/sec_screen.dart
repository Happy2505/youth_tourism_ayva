...
import 'package:youth_tourism_ayva/start_screen/th_screen.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 100),
            SvgPicture.asset('assets/Sec.svg'),
            SizedBox(height: 100),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24.0),
              child: Text(
                'Получи подтверждение от принимающего вуза',
            ...
            SizedBox(height: MediaQuery.of(context).size.height-565),
            ElevatedButton(
              onPressed: () {
                Navigator.of(context).push(CupertinoPageRoute(
                    builder: (context) => ThScreen()));
              },
              style: ButtonStyle(
