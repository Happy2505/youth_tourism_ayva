...
class LogingsID {
  ...
  factory LogingsID.fromJson(Map<String, dynamic> json) =>
      _$LogingsIDFromJson(json);

  LogingsID(this.id, this.soloConditions, this.orgConditions, this.name, this.address, this.foodType, this.minStayDuration, this.maxStayDuration, this.university, this.contact, this.images, this.documents, this.services, this.rooms);


  Map<String, dynamic> toJson() => _$LogingsIDToJson(this);
}
@JsonSerializable(explicitToJson: true)
class Rooms {
  final int id;
