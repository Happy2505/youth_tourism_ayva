...
part of 'scienceID.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ScienceID _$ScienceIDFromJson(Map<String, dynamic> json) => ScienceID(
      json['id'] as int,
      json['name'] as String,
...
Map<String, dynamic> _$ScienceIDToJson(ScienceID instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
